...
var getAquabrowserResults = module.exports.getAquabrowserResults = function(tenantAlias, query, callback) {
    ...
    req(options, function(err, res, body) {
        ...
        if (err) {
            return callback({'code': 500, 'msg': 'An error occured while parsing Aquabrowser data 1'});
        } else {
            ...
            var jsonstring = xml2js.parseString(xml, parseOpts, function(err, res) {
                ...
                if (err) {
                    return callback({'code': 500, 'msg': 'An error occured while parsing Aquabrowser data 2'});
                }
